...
public record struct BibleBook
{
    ...
    public static Dictionary<int, BibleBook> AllBooks => new()
    {
        ...
        { 8, new BibleBook(8, "Ruth", ["Ruth", "Rut", "Ru", "Rt"]) },
        ...
        { 26, new BibleBook(26, "Ezekiel", ["Ezek", "Ezk", "Eze", "Ez"]) },
        { 27, new BibleBook(27, "Daniel", ["Dan", "Da", "Dn"]) },
        { 28, new BibleBook(28, "Hosea", ["Hos", "Ho"]) },
        { 29, new BibleBook(29, "Joel", ["Joel", "Jl", "Jol", "joe"]) },
        { 30, new BibleBook(30, "Amos", ["Amos", "Amo", "Am"]) },
        { 31, new BibleBook(31, "Obadiah", ["Obad", "Oba", "Ob"]) },
        { 32, new BibleBook(32, "Jonah", ["Jon", "Jnh"]) },
        { 33, new BibleBook(33, "Micah", ["Mic", "Mi"]) },
        { 34, new BibleBook(34, "Nahum", ["Nah", "Nam", "Na"]) },
        ...
        { 46, new BibleBook(46, "1 Corinthians", ["1 Cor", "1Cor", "1Co", "1 Kor", "1Ko"]) },
        { 47, new BibleBook(47, "2 Corinthians", ["2 Cor", "2Cor", "2Co", "2 Kor", "2Ko"]) },
        ...
        { 52, new BibleBook(52, "1 Thessalonians", ["1 Thess", "1Thess", "1Th"]) },
        { 53, new BibleBook(53, "2 Thessalonians", ["2 Thess", "2Thess", "2Th"]) },
        { 54, new BibleBook(54, "1 Timothy", ["1 Tim", "1Tim", "1Ti"]) },
        { 55, new BibleBook(55, "2 Timothy", ["2 Tim", "2Tim", "2Ti"]) },
        { 56, new BibleBook(56, "Titus", ["Tit", "Titus", "Ti"]) },
        { 57, new BibleBook(57, "Philemon", ["Philem", "Phm", "Phlm"]) },
        { 58, new BibleBook(58, "Hebrews", ["Heb", "He"]) },
        { 59, new BibleBook(59, "James", ["Jas", "Jm", "Jak"]) },
        { 60, new BibleBook(60, "1 Peter", ["1 Pet", "1Pe", "1Pet", "1Pt"]) },
        { 61, new BibleBook(61, "2 Peter", ["2 Pet", "2Pe", "2Pet", "2Pt"]) },
        { 62, new BibleBook(62, "1 John", ["1 Jn", "1Jn", "1Jo", "1Joh", "1John"]) },
        { 63, new BibleBook(63, "2 John", ["2 Jn", "2Jn", "2Jo", "2Joh", "2John"]) },
        { 64, new BibleBook(64, "3 John", ["3 Jn", "3Jn", "3Jo", "3Joh", "3John"]) },
