...
public class SblTextDownloader : IFileDownloader
{
    private readonly IFileService _fileService;
    private readonly HttpClient _httpclient;
    private readonly ILogger<SblTextDownloader> _logger;
    private readonly AppSettings _options;

    public SblTextDownloader(IFileService fileService, IHttpClientFactory httpclient, IOptions<AppSettings> options,
        ILogger<SblTextDownloader> logger)
    {
    ...
    {
        _fileService.CreateDirectoryIfNotExists(new DirectoryInfo(_options.DatabaseSeeding.SblSettings.TextFilePath).Parent.FullName);
        _fileService.CreateDirectoryIfNotExists(_options.DatabaseSeeding.SblSettings.TextFilePath);
    }
}
