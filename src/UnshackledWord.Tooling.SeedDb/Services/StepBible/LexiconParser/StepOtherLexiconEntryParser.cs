...
public sealed class StepOtherLexiconEntryParser : IStepLexiconParserStrategy<ILexiconEntry<BibleEntity>>
{
    public ILexiconEntry<BibleEntity> Parse(List<(LineType LineType, string Line)> entryLines)
    {
        var entry = new OtherRecord();
    ...
    private void ProcessNamed(OtherRecord entry, string[] parts)
    {
    ...
    private void ProcessFirstLine(OtherRecord entry, string[] parts)
    {
