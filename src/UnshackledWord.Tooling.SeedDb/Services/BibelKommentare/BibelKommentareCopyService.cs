...
public class BibelKommentareCopyService : IFileDownloader
{
    ...
    public BibelKommentareCopyService(IFileService fileService, IOptions<AppSettings> options,
    ...
    public async Task<List<string>> DownloadFileAsync(CancellationToken token = default)
    {
        ...
        _fileService.Copy(_options.DatabaseSeeding.BibleKommentareSourcePath,
            _options.DatabaseSeeding.BibleKommentareDestinationPath, true);
